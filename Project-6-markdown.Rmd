...
The model fitting has been carried out in four phases; first model has been fitted to include all other variables except HbA1c.This model is as displayed below.

```{r, echo=TRUE}
fit <- glm(readmitted ~ discharge_disposition_id + race + admission_source_id + medical_specialty + time_in_hospital + age + diag_1 + A1Cresult, data = new_df, family = "binomial")
summary(fit)
